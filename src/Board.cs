...
namespace GameLogic
{
    public class Board
    {
        ...
        {
            tiles = new List<Tile>();
            hexNames = new List<string>();
            hexNames.Add("Frozen Waste");
            hexNames.Add("Forest");
            hexNames.Add("Plains");
            hexNames.Add("Jungle");
            hexNames.Add("Swamp");
            hexNames.Add("Mountain");
            hexNames.Add("Desert");
            hexNames.Add("Frozen Waste");
            hexNames.Add("Forest");
            hexNames.Add("Plains");
        ...
        {
            string s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(1 , new int[]{2 , 3 , 4 , 5 , 6 , 7 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(2 , new int[]{9 , 10, 3 , 1 , 7 , 8 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(3 , new int[]{10, 11, 12, 4 , 1 , 2 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(4 , new int[]{3 , 12, 13, 14, 5 , 1 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(5 , new int[]{1 , 4 , 14, 15, 16, 6 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(6 , new int[]{7 , 1 , 5 , 16, 17, 18}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(7 , new int[]{8 , 2 , 1 , 6 , 18, 19}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(8 , new int[]{21, 9 , 2 , 7 , 19, 20}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(9 , new int[]{22, 23, 10, 2 , 8 , 21}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(10, new int[]{23, 24, 11, 3 , 2 , 9 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(11, new int[]{24, 25, 26, 12, 3 , 10}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(12, new int[]{11, 26, 27, 13, 4 , 3 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(13, new int[]{12, 27, 28, 29, 14, 4 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(14, new int[]{4 , 13, 29, 30, 15, 5 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(15, new int[]{5 , 14, 30, 31, 32, 16}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(16, new int[]{6 , 5 , 15, 32, 33, 17}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(17, new int[]{18, 6 , 16, 33, 34, 35}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(18, new int[]{19, 7 , 6 , 17, 35, 36}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            ...
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(21, new int[]{0 , 22, 9 , 8 , 20, 0 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(22, new int[]{0 , 0 , 23, 9 , 21, 0 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            ...
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(25, new int[]{0 , 0 , 0 , 26, 11, 24}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(26, new int[]{25, 0 , 0 , 27, 12, 11}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(27, new int[]{26, 0 , 0 , 28, 13, 12}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            ...
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(30, new int[]{14, 29, 0 , 0 , 31, 15}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(31, new int[]{15, 30, 0 , 0 , 0 , 32}, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            ...
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(34, new int[]{35, 17, 33, 0 , 0 , 0 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(35, new int[]{36, 18, 17, 34, 0 , 0 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(36, new int[]{37, 19, 18, 35, 0 , 0 }, s));
            hexNames.Remove(s);
            s = hexNames[r.Next(hexNames.Count)];
            tiles.Add(new Tile(37, new int[]{0 , 20, 19, 36, 0 , 0 }, s));
            hexNames.Remove(s);

            /*THIS IS THE ORIGINAL HARDCODED TILES

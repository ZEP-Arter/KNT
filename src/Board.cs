...
namespace GameLogic
{
    class Board
    {
        ...
        public void initBoard()
        {
            ...
            tiles.add(new Tile(20, {0 , 21, 8 , 19, 37, 0 }, "Swamp"));
            ...
            tiles.add(new Tile(24, {0 , 0 , 25, 11, 10, 23}, "Desert"));
            ...
            tiles.add(new Tile(29, {13, 28, 0 , 0 , 30, 14}, "Jungle"));
            ...
            tiles.add(new Tile(33, {17, 16, 32, 0 , 0 , 34}, "Jungle"));
